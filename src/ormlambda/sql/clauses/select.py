...
from .interfaces import ISelect

if TYPE_CHECKING:
    from ormlambda import Table


class _Select[T: Type[Table], *Ts](DecompositionQueryBase[T, *Ts], ISelect):
    CLAUSE: str = "SELECT"
    ...
    # TODOL: see who to deal when we will have to add more methods
    @override
    @property
    def query(self) -> str:
