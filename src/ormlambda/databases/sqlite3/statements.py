...
from ormlambda.sql.clauses import _Delete as DeleteQuery
...
from ormlambda.sql.clauses import _Upsert as UpsertQuery
from ormlambda.sql.clauses import _Update as UpdateQuery
from ormlambda.sql.clauses import _Where as Where
from ormlambda.sql.clauses import _Having as Having
from ormlambda.sql.clauses import _Count as Count
...
@staticmethod
def clear_list[T, **P](f: Callable[Concatenate[SQLiteStatements, P], T]) -> Callable[P, T]:
    def wrapper(self: SQLiteStatements, *args: P.args, **kwargs: P.kwargs) -> T:
        try:
...
class SQLiteStatements[T, *Ts](BaseStatement[T, None]):
    def __init__(self, model: tuple[T, *Ts], repository: BaseRepository[None]) -> None:
