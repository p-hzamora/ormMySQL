...
from ormlambda.common.abstract_classes.clause_info import ClauseInfo, AliasType, TableType, ColumnType
...
class DecompositionQueryBase[T: TableType, *Ts](IDecompositionQuery[T, *Ts]):
    ...
    def _IAggregate_type(self, aggregate_method: IAggregate) -> ClauseInfo[T]:
        return ClauseInfo[T](IAggregate, aggregate_method.query, alias_clause=aggregate_method.alias_clause, context=self._context)
