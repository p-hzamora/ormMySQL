...
class TestSQLStatements(unittest.TestCase):
    ...
    def test_select_raise_ValueError_with_aggregate_functions_without_flavour_dict(self):
        ...
        with self.assertRaises(FunctionFunctionError) as e:
