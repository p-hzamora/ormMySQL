...
def create_engine_for_db(db_name: str) -> BaseRepository:
    database = DATABASE_URL.split("/")[-1]
    URL = DATABASE_URL.replace(f"/{database}", f"/{db_name}")
...
class TestSQLStatements(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.ddbb = create_engine("mysql://root:1500@localhost:3306")
    ...
    def test_insert(self):
        ...
        select_query = self.tmodel.where(TestTable.Col1 == id).select_one()
    ...
    def test_update_with_column_as_keys(self):
        ...
        self.tmodel.where(TestTable.Col1 == 3).update(
            {
                TestTable.Col2: 2,
                TestTable.Col5: 5,
                TestTable.Col13: 13,
        ...
        result = self.tmodel.where(TestTable.Col1 == 3).select_one()
    ...
    def test_update_with_str_as_keys(self):
        ...
        self.tmodel.where(TestTable.Col1 == ROW_TO_UPDATE).update(
            {
                "Col2": 22,
                "Col5": 55,
                "Col13": 133,
        ...
        result = self.tmodel.where(TestTable.Col1 == ROW_TO_UPDATE).select_one(
            lambda x: (
                x.Col2,
                x.Col5,
                x.Col13,
    ...
    def test_upsert(self):
        ...
        select_row_0 = self.tmodel.where(TestTable.Col1 == 1).select_one()
    ...
    def test_offset(self):
        ...
        select_row_11 = self.tmodel.where(TestTable.Col1 == 11).select_one()
    ...
    def test_delete(self):
        ...
        self.tmodel.where(TestTable.Col1 == 2).delete()
    ...
    def test_select_and_where_clause(self):
        ...
        select = model.where((Address.address_id <= 50) & (Address.address_id >= 10)).select_one(
            lambda x: (
                model.max(x.address_id),
                model.min(x.address_id),
            ),
            flavour=dict,
        )
    ...
    def test_where(self):
        instance = create_instance_of_TestTable(3)
        self.tmodel.insert(instance)
        where_clause = self.tmodel.where(TestTable.Col1 == 2).select_one()
...
class TestSQLStatementsWithAutoGenerated(unittest.TestCase):
    ...
    def test_insert_with_autogenerated_columms_and_values_not_None(self):
        ...
        instance_5 = self.tmodel.where(TableWithAutoGenerated.Col_pk_auto_increment == 5).select_one()
    ...
    def test_update_with_autogenerated_columms(self):
        ...
        # region update
        self.tmodel.where(TableWithAutoGenerated.Col_pk_auto_increment == 1).update(
            {
    ...
    def test_upsert_with_autogenerated_columns(self):
        def get_Col_auto_generated_value(number: int):
            return self.tmodel.where(TableWithAutoGenerated.Col_pk_auto_increment == number).select_one().Col_auto_generated
...
class TestAggregateFunctions(unittest.TestCase):
    ...
    def test_in_statement(self):
        ...
        select = model.where(Address.address_id.contains(filter_by)).select(Address.address_id, flavour=tuple)
    ...
    def test_select_with_custom_flavour(self):
        ...
        model = ORM(Address, ddbb)
        select = (
            model.order(Address.City.Country.country, "DESC")
            .limit(10)
