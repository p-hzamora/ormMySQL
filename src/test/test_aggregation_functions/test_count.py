...
class TestCount(unittest.TestCase):
    ...
    def test_count_with_D_table_and_passing_table_context(self) -> None:
        ...
        self.assertEqual(Count(D, alias_table="{table}", dialect=DIALECT).query(DIALECT), query)
    ...
    def test_count_passing_column_with_context(self) -> None:
        ...
        self.assertEqual(Count(D.data_d, alias_table="{table}", alias_clause="other_name", dialect=DIALECT).query(DIALECT), query)
