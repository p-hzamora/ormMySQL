...
class TestSQLStatementsWithAutoGenerated(unittest.TestCase):
    ...
    def test_upsert_with_autogenerated_columns(self):
        self.tmodel.insert(create_instance_of_TestTable(20))

        CURRENT_DATETIME = datetime(1998, 12, 16)
        REAL_AUTOGENERATED_VALUE: datetime = self.tmodel.select_one().Col_auto_generated
...
from ormlambda.databases.my_sql.functions import Concat, Count  # noqa: E402
...
class TestGroupBy(unittest.TestCase):
    def setUp(self):
        ...
        self.model = TestTableModel(self.ddbb)
        self.model.create_table()

    def test_group_by(self):
        instances = create_instance_of_TestTable(5)
        self.model.insert(instances)

        self.model.group_by(
            lambda x: x.Col3,
            lambda x: (
                x.Col3,
                Concat(TestTable, lambda x: (x.Col3, x.Col13, x.Col12)),
                Count(TestTable, lambda x: x.Col3),
            ),
        )
